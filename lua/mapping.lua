...
keymaps = {
    ...
    { "n", "<leader>c", ":Telescope themes<CR>",
    ...
    { "n", "<leader>ft", ":Telescope live_grep<CR>",
    ...
    { "n", "<leader>fh", ":Telescope oldfiles<CR>",
        { desc = "recently opened", noremap = true, silent = true },
    },

    { "n", "<leader>gs", ":lua require('snacks').lazygit.open()<cr>",
        { desc = "local git repo", noremap = true, silent = true },
    },
    { "n", "<leader>t", ":ToggleTerm direction=float name=terminal<cr>",
